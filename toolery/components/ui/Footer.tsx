  ...
  return (
    <footer className="mt-20 border-t border-white/10">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-10 grid gap-8 sm:grid-cols-3">
        <div>
          <div className="font-display text-lg font-semibold text-fg">Toolery</div>
      ...
      <div className="border-t border-white/10 py-5 text-center text-xs text-muted">
        © {new Date().getFullYear()} Toolery. All calculations are estimates — verify anything financial or legal with an official source.
      </div>
    </footer>
  );
}
